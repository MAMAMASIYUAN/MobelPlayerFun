...
import com.example.iori.mobelplayerfun.domain.SpeechBean;
import com.example.iori.mobelplayerfun.utils.ConversationInfo;
import com.example.iori.mobelplayerfun.utils.ResouesUtils;
import com.example.iori.mobelplayerfun.utils.SpeechUtils;
        ...
        public void onResult(RecognizerResult recognizerResult, boolean isLast) {
            ...
            if (isLast) { // true, 所有的数据都解析完闭. 赋值给askerText
                ...
                if (askerText.contains("美女")) {
                    ...
                    if (ActivityCompat.checkSelfPermission(AIActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
...
//                   photoUri = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
                ...
                }else if(askerText.contains("主席是谁")) {
                    answer = ResouesUtils.mmTextArray[5];
                }else if(askerText.contains("总理是谁")) {
            ...
            // 把answer说出来
            mSpeechUtils.speakText(AIActivity.this, answer);
        }

        @Override
        public void onError(SpeechError speechError) {
            Toast.makeText(AIActivity.this, "识别出错了", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view = null;
            if(convertView == null) {
                view = View.inflate(AIActivity.this, R.layout.listview_item, null);
            } else {
                view = convertView;
            }
